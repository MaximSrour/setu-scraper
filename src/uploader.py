...
tables = {
	"offerings": dbTable("setu-visualiser_offerings", "../output/offerings.csv"),
	"aspectData": dbTable("setu-visualiser_aspect_data", "../output/aspectData.csv"),
	"aspectDefinitions": dbTable("setu-visualiser_aspect_definitions", "../output/aspectDefs.csv"),
}
